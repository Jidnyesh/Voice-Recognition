        ...
        gradient1.addColorStop(0.2, '#00ff73');
        gradient1.addColorStop(1, '#23ffff');


        const gradient2 = ctx.createLinearGradient(0, 0, w, 0);
        gradient2.addColorStop(0.2, '#ff04d5');
        gradient2.addColorStop(1, '#1900ff');

        const gradient3 = ctx.createLinearGradient(0, 0, w, 0);
        gradient3.addColorStop(0.2, '#00F260');
        gradient3.addColorStop(1, '#0575E6');

        const gradient4 = ctx.createLinearGradient(0, 0, w, 0);
        gradient4.addColorStop(0.3, '#FDFC47');
        gradient4.addColorStop(1, '#24FE41');
